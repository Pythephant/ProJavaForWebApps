        ...
        <script type="text/javascript" language="javascript">
        	...
        	$(document).ready(function(){
    			...
    			server.onclose = function(event){
    				if(server!=null)
    					infoMessage('Disconneted from the chat server.');
    				server = null;
    			...
    			send = function(){
    				...
    				if(server == null){
    					...
    					modalErrorBody.text('Waiting for other user to join the chat.');
    					modalError.modal('show');
    				}else if(thisContent.trim().length > 0){
    					var message = {
    						timestamp: new Date(),
    						type: 'TEXT',
    						user: username,
